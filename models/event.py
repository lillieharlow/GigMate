...
class Event(db.Model):
    ...
    Attributes:
        ...
        duration_hours (float): Duration of the event in hours (must be >0 and <=12).
    ...
    Constraints:
        - duration_hours must be greater than 0 and at most 12.
        - Unique combination of title and description to prevent duplicates.

    Relationships and delete behavior:
        - Each event is organised by one organiser (organiser_id set to NULL if organiser deleted).
